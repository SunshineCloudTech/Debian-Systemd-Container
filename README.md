...
```bash
# AMD64 基础镜像
docker pull sunshinecloud007/sunshinecloud-systemd-devcontainer:amd64-bookworm
docker pull sunshinecloud007/sunshinecloud-systemd-devcontainer:amd64-noble

# ARM64 基础镜像
docker pull sunshinecloud007/sunshinecloud-systemd-devcontainer:arm64-bookworm
docker pull sunshinecloud007/sunshinecloud-systemd-devcontainer:arm64-noble
```
...
docker run --detach --privileged \
  ...
  sunshinecloud007/sunshinecloud-systemd-devcontainer:amd64-bookworm
```
